...
# Micronaut Application Startup Script
# Port: 8083
...
if [ ! -f "target/micronaut-app-1.0.0.jar" ]; then
...
# Run the application
java $JAVA_OPTS -jar target/micronaut-app-1.0.0.jar

echo -e "${GREEN}✅ $APP_NAME started successfully!${NC}"
echo -e "${GREEN}🌐 Application URL: http://localhost:$PORT${NC}"
echo -e "${GREEN}📖 Swagger UI: http://localhost:$PORT/swagger-ui${NC}"
