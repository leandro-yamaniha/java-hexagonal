...
# Quarkus Application Startup Script
# Port: 8081
...
if nc -z localhost 6379; then
    ...
    echo -e "${YELLOW}⚠️  Redis is not accessible (optional for Quarkus)${NC}"
fi
...
# Run the application (Quarkus fast-jar)
...
echo -e "${GREEN}📖 Swagger UI: http://localhost:$PORT/q/swagger-ui${NC}"
